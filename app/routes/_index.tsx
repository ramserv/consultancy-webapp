    ...
    <>
          ...
          <div className="flex items-center w-full lg:w-1/2">
            <div className="max-w-2xl mb-8 mr-8">
              ...
              <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
                ...
                Experiences & Solutions, utilising highly skilled professionals
      ...
      <MotionSection>
        <SectionTitle preTitle="Our Benefits" title="Why should you choose us?">
          At RamServ, we combine innovation with expertise to create
          cutting-edge digital solutions tailored to your needs. Our team
          focuses on integrating the latest technology into existing products,
