    ...
    <>
      <div className="flex flex-wrap container px-8 py-3 mx-auto xl:px-0 min-h-screen">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8 mr-8">
            ...
            <p className="py-5 text-xl leading-normal text-gray-500 lg:text-xl xl:text-2xl dark:text-gray-300">
              At RamServ, we act as your Partners in Crafting Seamless Digital
              Experiences & Solutions, utilising highly skilled professionals in
              technical domains.
            </p>
        ...
        <div className="flex items-center justify-center w-full lg:w-1/2">
          <div className="">
            {/* <img src={cover1} alt="photo one" /> */}
            <img src={cover2} alt="photo one" />
          </div>
        </div>
      ...
      <div className="flex flex-wrap container px-8 mx-auto xl:px-0">
        <div className="flex flex-col justify-center w-full">
          ...
          {/* <div className="flex flex-wrap justify-start gap-5 mt-10 md:justify-around animate-marquee">
            <div className="pt-2 text-gray-400 dark:text-gray-400">
              <AmazonLogo />
            </div>
            <div className="text-gray-400 dark:text-gray-400">
      ...
      <SectionTitle preTitle="Our Benefits" title="Why should you choose us?">
        At RamServ, we combine innovation with expertise to create cutting-edge
        digital solutions tailored to your needs. Our team focuses on
        integrating the latest technology into existing products, ensuring
