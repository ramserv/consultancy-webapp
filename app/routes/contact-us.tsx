...
export default function ContactUs(_: Route.ComponentProps) {
  ...
  let errors: Partial<Errors> = fetcher.data?.errors;
  return (
    <>
        ...
        <div className="md:w-3/4 lg:w-3/4 mt-4 p-6 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
          ...
          <fetcher.Form method="post">
              ...
              <div className="w-full sm:w-1/2">
                ...
                <div className="relative">
                  ...
                  {errors?.fullNameError ? (
                    <em className="text-sm text-red-500 mt-1 block font-medium">
                      * {errors.fullNameError}
                    </em>
                  ) : null}
                </div>
            ...
            <div className="flex justify-end gap-4.5">
              ...
              <button
                className="flex justify-center rounded bg-ramserv py-2 px-6 font-medium text-gray hover:bg-opacity-90"
                type="submit"
              >
                Save
              </button>
